...
public class ProfessorController<id> {
    @Autowired
    ...
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteById(@RequestBody Professor professor, @PathVariable Long id) {
        professorService.deleteById(id, professor);
    }
}